...
public abstract class AppDatabase extends RoomDatabase {
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        private void insertTransactionDirectionsAndTypes() {
            ...
            // Income Types
            TransactionType wage = new TransactionType("Wage", 1, R.drawable.ic_taxes_and_charges);                    // id=10
            TransactionType rentalIncome = new TransactionType("Rental Income", 1, R.drawable.ic_taxes_and_charges);   // id=11
            TransactionType interest = new TransactionType("Interest/Dividend", 1, R.drawable.ic_taxes_and_charges);   // id=12
            TransactionType coupon = new TransactionType("Coupon/Voucher", 1, R.drawable.ic_discount);        // id=13
            TransactionType gift = new TransactionType("Gift", 1, R.drawable.ic_gift);                    // id=14
            TransactionType welfare = new TransactionType("Welfare", 1, R.drawable.ic_other);              // id=15
        ...
        private void insertTransactionSubtypes() {
            ...
            TransactionSubtype restricted = new TransactionSubtype("Alcohol & Cigarettes", 1, R.drawable.ic_alcohol);      // id=4
            ...
            // Shopping
            TransactionSubtype clothes = new TransactionSubtype("Clothes & Shoes", 2, R.drawable.ic_shopping);              // id=5
            TransactionSubtype cosmetics = new TransactionSubtype("Cosmetics", 2, R.drawable.ic_shopping);                  // id=6
            ...
            TransactionSubtype furniture = new TransactionSubtype("Furniture & Garden", 2, R.drawable.ic_garden);         // id=10
            TransactionSubtype accessories = new TransactionSubtype("Accessories", 2, R.drawable.ic_shopping);              // id=11
            TransactionSubtype kids = new TransactionSubtype("Kids", 2, R.drawable.ic_kids);                            // id=12
            ...
            // Entertainment
            TransactionSubtype events = new TransactionSubtype("Culture & Sport Events", 3, R.drawable.ic_sport_events);        // id=14
            TransactionSubtype travel = new TransactionSubtype("Holidays & Trips", 3, R.drawable.ic_holiday);              // id=15
            ...
            TransactionSubtype charity = new TransactionSubtype("Charity", 3, R.drawable.ic_taxes_and_charges);                      // id=21
            TransactionSubtype hazart = new TransactionSubtype("Lottery & Gambling", 3, R.drawable.ic_taxes_and_charges);            // id=22
            ...
            TransactionSubtype business = new TransactionSubtype("Business Trips", 4, R.drawable.ic_bussiness_trip);              // id=25
            ...
            TransactionSubtype hamali = new TransactionSubtype("Furniture Moving", 4, R.drawable.ic_furniture_moving);              // id=28
            TransactionSubtype spodeleno = new TransactionSubtype("Shared Travel", 4, R.drawable.ic_bussiness_trip);              // id=29
            ...
            TransactionSubtype leasing = new TransactionSubtype("Leasing", 5, R.drawable.ic_vehicle);                      // id=32
            TransactionSubtype insurance = new TransactionSubtype("Vehicle Insurance", 5, R.drawable.ic_vehicle);          // id=33
            TransactionSubtype remont = new TransactionSubtype("Maintenance & Repairs", 5, R.drawable.ic_repair);         // id=34
            TransactionSubtype rental = new TransactionSubtype("Rentals", 5, R.drawable.ic_vehicle);                       // id=35
            ...
            // Taxes & Charges
            TransactionSubtype insurances = new TransactionSubtype("Insurances", 6, R.drawable.ic_taxes_and_charges);                // id=36
            TransactionSubtype fines = new TransactionSubtype("Fines", 6, R.drawable.ic_taxes_and_charges);                          // id=37
            TransactionSubtype loan = new TransactionSubtype("Loans & Interests", 6, R.drawable.ic_taxes_and_charges);               // id=38
            TransactionSubtype taxes= new TransactionSubtype("Taxes", 6, R.drawable.ic_taxes_and_charges);                           // id=39
            TransactionSubtype childSupport = new TransactionSubtype("Child Support", 6, R.drawable.ic_taxes_and_charges);           // id=40
            TransactionSubtype advice = new TransactionSubtype("Advisory", 6, R.drawable.ic_taxes_and_charges);                      // id=41
            ...
            // Housing
            TransactionSubtype bills = new TransactionSubtype("Bills & Utilities", 7, R.drawable.ic_housing);              // id=42
            TransactionSubtype repairs = new TransactionSubtype("Repairs & Maintenance", 7, R.drawable.ic_housing);        // id=43
            TransactionSubtype rent = new TransactionSubtype("Rent", 7, R.drawable.ic_housing);                            // id=44
            TransactionSubtype propertyInsurance = new TransactionSubtype("Property Insurance", 7, R.drawable.ic_housing); // id=45
            TransactionSubtype mortgage = new TransactionSubtype("Mortgage", 7, R.drawable.ic_housing);                    // id=46
            TransactionSubtype services = new TransactionSubtype("Services", 7, R.drawable.ic_housing);                    // id=47
            ...
            // Investments
            TransactionSubtype savings = new TransactionSubtype("Savings", 8, R.drawable.ic_investment);                      // id=48
            TransactionSubtype investments = new TransactionSubtype("Financial Investments", 8, R.drawable.ic_investment);    // id=49
            TransactionSubtype realty = new TransactionSubtype("Realty", 8, R.drawable.ic_investment);                        // id=50
            TransactionSubtype collection = new TransactionSubtype("Cash Collection", 8, R.drawable.ic_investment);           // id=51
            ...
            // Income Subtypes
            TransactionSubtype wage = new TransactionSubtype("Wage", 10, R.drawable.ic_taxes_and_charges);                    // id=53
            TransactionSubtype rentalIncome = new TransactionSubtype("Rental Income", 11, R.drawable.ic_taxes_and_charges);   // id=54
            TransactionSubtype interest = new TransactionSubtype("Interest/Dividend", 12, R.drawable.ic_taxes_and_charges);   // id=55
            TransactionSubtype coupon = new TransactionSubtype("Coupon/Voucher", 13, R.drawable.ic_discount);        // id=56
            TransactionSubtype incomeGift = new TransactionSubtype("Gift", 14, R.drawable.ic_gift);              // id=57
            TransactionSubtype welfare = new TransactionSubtype("Welfare", 15, R.drawable.ic_other);              // id=58
        ...
        private void insertSampleAccountsAndTransactions() {
            ...
            // Transactions
            Transaction tran1 = new Transaction(date, 51.24, "canned food", 1, 1, R.drawable.ic_shopping);
